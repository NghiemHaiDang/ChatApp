...
import vn.edu.fpt.chatapp.databinding.ActivitySignInBinding;
...
public class SignInActivity extends AppCompatActivity {
    ...
    private void signIn(){
        ...
        database.collection(Constants.KEY_COLLECTION_USERS)
                        ...
                        .whereEqualTo(Constants.KEY_PASSWORD,binding.inputPassword.getText().toString()).get().addOnCompleteListener(
                        task ->{
